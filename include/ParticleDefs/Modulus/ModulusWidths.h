...
private:
    ...
    std::deque< Models::PartialWidth > widthNeutralinos();
    ...
    std::deque< Models::PartialWidth > widthCharginos();
    ...
    std::deque< Models::PartialWidth > widthHiggsHiggs();
    ...
    std::deque< Models::PartialWidth > widthDiAxionic();
public:
    ModulusWidths(const ModelBase& model, const std::deque< Models::Particle >& particles);
    ~ModulusWidths();
