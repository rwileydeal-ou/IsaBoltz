...
private:
    ...
    std::vector< Models::PartialWidth > widthNeutralinos();
    ...
    std::vector< Models::PartialWidth > widthCharginos();
    ...
    std::vector< Models::PartialWidth > widthHiggsHiggs();
    ...
    std::vector< Models::PartialWidth > widthDiAxionic();
public:
    ModulusWidths(
