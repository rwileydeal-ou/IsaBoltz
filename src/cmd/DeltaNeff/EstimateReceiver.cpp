...
double EstimateDeltaNeffReceiver::calculateRhoTD(double TDecay, double gStrEnt_TD){
    ...
    double gStrEnt_Tosc = GStar::CalculateEntropic( db_, connection_, Tosc.Temperature );
...
double EstimateDeltaNeffReceiver::calculateDeltaNeff(){
    ...
    double gStrEnt_TD = GStar::CalculateEntropic(db_, connection_, TD.Temperature);
    ...
    double preEnt = GStar::Calculate( db_, connection_, TS ) / TD.GStar;
